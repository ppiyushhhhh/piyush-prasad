...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "google-site-verification", content: "K1jY27s3c8in51n399XWyedM9KQrwIQb0gYdcLoinBk" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Piyush Prasad — Portfolio" },
      { property: "og:locale", content: "en_US" },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/c909e907-efb4-401c-9b45-48a20e30711a" },
      { property: "og:image:alt", content: "Piyush Prasad — Cloud & DevOps Engineer portfolio" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/c909e907-efb4-401c-9b45-48a20e30711a" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600&family=Archivo+Black&family=JetBrains+Mono:wght@400;500&display=swap" },
    ],
    scripts: [
      {
